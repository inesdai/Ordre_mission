...
public class Layer {
    ...
    public List<Marker> getMarkers() {
        ...
        //  System.out.println("getmarkers:latitude:" + markers.get(0).getPosition().getLatitude());
        // markers.add(0,markers.get(markers.size()-1));        
    ...
    public Layer updateMarker(Marker marker) {
        if (markers.size() == 0 || markers.isEmpty()) {
            ...
            this.markers.set(markers.indexOf(marker), marker);
            //this.markers.remove(marker);
            // System.out.println("markers:" + markers.size());
            // System.out.println(markers.get(0).getPosition().getLatitude() + "latitude");
            return this;
        }
    }
