 ...
 * @author user
 */
public class PdfAlarmDetailsConverter {
    ...
    public PdfAlarmDetailsConverter(User connectedUser) {
    ...
    public void exportPDF(DataModel items) {
        ...
        try {
            ...
            String FILE = "/home/veganet/pdfExport/" + connectedUser.getUserid() + "AlarmDetailsPdf.pdf";
    ...
    private void generatePDF(Document document, PdfWriter writer, DataModel items)
        ...
        Paragraph preface2 = new Paragraph("Détails des alarmes", catFont);
        ...
        table.addCell(c1);
        c1 = new PdfPCell(new Phrase("Type d'alarme"));
        ...
        float[] columnWidths = new float[]{20f, 20f, 25f, 25f};
        ...
        while (i.hasNext()) {
            ...
            table.addCell(ve.getAlarmTypeText() + "");
    ...
    public void download() throws IOException {
        ...
        String basepath = "/home/veganet/pdfExport/" + connectedUser.getUserid() + "AlarmDetailsPdf.pdf";
        ...
        ec.setResponseHeader("Content-Disposition", "attachment; filename=\"" + "AlarmDetailsPdf.pdf" + "\""); // The Save As popup magic is done here. You can give it any file name you want, this only won't work in MSIE, it will use current request URL as file name instead.
